...
# featuredImage: $lib/assets/content/demo/demo.webp
...
<script lang='ts'>
    ...
    import Second_Image from "$lib/assets/content/demo/car.webp"
...
<TopImage image={Second_Image} imageAlt={featuredImageAlt}  />

source : <Link source="source" title="title" />
